...
{{ windows_icon }}  --- Automated Installation Error
==========================================================

.. card::

    It looks like there was an error during the installation script which unfortunately happens sometimes. Please try to use `this guide <manual.html>`_ instead. You are also more than welcome to visit us during our office hours, or contact us via :mail:`e-mail <pythonsupport@dtu.dk>` or `Discord <ps-discord-invite>`_.
