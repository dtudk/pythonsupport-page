...
- Open VSCode.
- Hold :kbd:`Ctrl+Shift+P` (or :kbd:`Cmd+Shift+P` on Mac) to open the command palette.
...
- If you are already in a notebook from a course, navigate to the top middle and press :kbd:`Run All`.
- Otherwise click on the first cell and type your Python code.
- To run a cell, press :kbd:`Shift+Enter` or click the "Run" button in the toolbar.
