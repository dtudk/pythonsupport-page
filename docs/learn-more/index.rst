...
.. dropdown:: Are you a first year student?
   ...
   The :doc:`Visual Studio Code <vscode/index>` section is also very useful, but **Visual Studio Code will not be introduced until around week 7**
   of your studies. 
...
* :doc:`IDLE <idle>` is recommended only if taking course 02002 - Introduction to Pytohn Programming
